...
class RoboticArm:
    ...
    def __init__(self, name_string, dof):
    ...
    def forward_kinematics_computing(self, theta: np.array):
        ...
        # self.endEffector_pose = np.identity(4)
        # get_transformation_matrix_from_rotation_and_translation(np.identity(3), np.array([[0], [0], [1.301]]))
        self.endEffector_pose = get_transformation_matrix_from_rotation_and_translation(np.identity(3), np.array([[0], [0], [1.301]]))
...
robot = RoboticArm("Kuka_iiwa_14", 7)
